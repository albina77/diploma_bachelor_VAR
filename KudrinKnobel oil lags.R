# 3 -  Кудрин Кнобель с лагами экзогенной
...
seas_real_oil_price_cpi <- real_oil_price["seas_real_oil_cpi"][1:80,]
seas_real_oil_price_cpi_ts <- ts(seas_real_oil_price_cpi, start=c(2003, 1), end=c(2022, 2), frequency = 4)
...
dummy_2006 <- ts(numeric(1), start = c(2004, 1), end = c(2022, 2), frequency = 4)
dummy_2006[12] <- 1
...
seas_real_oil_price_cpi <- real_oil_price["seas_real_oil_cpi"][6:80,]
seas_real_oil_price_cpi_ts <- ts(seas_real_oil_price_cpi, start=c(2004, 2), end=c(2022, 2), frequency = 4)
...
seas_real_oil_price_cpi <- real_oil_price["seas_real_oil_cpi"][7:80,]
seas_real_oil_price_cpi_ts <- ts(seas_real_oil_price_cpi, start=c(2004, 3), end=c(2022, 2), frequency = 4)
...
lagselect <- VARselect(sv, lag.max = 4, "const", exogen = oil_to_3)
lagselect$selection

Model <- VAR(sv, p = 3, season = NULL, exogen = oil_to_3, type = "const")
